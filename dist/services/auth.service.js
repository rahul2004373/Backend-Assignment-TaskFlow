...
export const authService = {
    ...
    async login(data) {
        ...
        const accessToken = jwt.sign({ id: user.id, email: user.email }, secretKey, { expiresIn: accessExpiration });
    ...
    async refresh(data) {
        ...
        const accessToken = jwt.sign({ id: tokenRecord.user.id, email: tokenRecord.user.email }, secretKey, { expiresIn: accessExpiration });
        return {
            accessToken,
